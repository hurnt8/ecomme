...
class CategorySeeder extends Seeder
{
    public function run(): void
    {
        ...
        $categories = [
            ['name' => 'Tondeuses', 'slug' => 'tondeuses', 'description' => 'Tondeuses thermiques, électriques et à batterie, poussées ou tractées, du petit jardin de ville au terrain de plusieurs milliers de mètres carrés.', 'sort_order' => 0],
            ['name' => 'Robots tondeuses', 'slug' => 'robots-tondeuses', 'description' => 'Robots avec fil périphérique ou sans installation, pour que la tonte cesse d\'être une tâche — du jardin de ville au parc de plusieurs hectares.', 'sort_order' => 1],
            ['name' => 'Tracteurs tondeuses & Autoportées', 'slug' => 'tracteurs-autoportees', 'description' => 'Autoportées à éjection arrière, latérale ou avec bac, pour les terrains que l\'on ne tond plus raisonnablement à pied.', 'sort_order' => 2],
            ['name' => 'Tronçonneuses & Élagage', 'slug' => 'tronconneuses-elagage', 'description' => 'Tronçonneuses, élagueuses et perches télescopiques pour couper en hauteur sans échelle, du verger à la coupe de bois de chauffage.', 'sort_order' => 3],
            ...
            ['name' => 'Outils pour tracteur', 'slug' => 'outils-tracteur', 'description' => 'Broyeurs à marteaux, bennes, fourches, charrues, herses et remorques à atteler en trois points, choisis pour la puissance de tracteur que vous avez déjà.', 'sort_order' => 6],
            ...
            ['name' => 'Bois & Chauffage', 'slug' => 'bois-chauffage', 'description' => 'Bûches, granulés, briquettes et poêles livrés chez vous — le prolongement naturel d\'une saison passée à couper et à débroussailler.', 'sort_order' => 8],
            ['name' => 'Barbecues & Fours d\'extérieur', 'slug' => 'barbecues-fours', 'description' => 'Barbecues et fours à pizza pour l\'extérieur comme pour la cuisine, à bois, à charbon ou à gaz.', 'sort_order' => 9],
            ['name' => 'Piscines & Spas', 'slug' => 'piscines', 'description' => 'Piscines gonflables, tubulaires, hors sol et en bois, avec les robots nettoyeurs et les accessoires qui vont avec.', 'sort_order' => 10],
