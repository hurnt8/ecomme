...
return [
    ...
    */
    ...
    'prohibited_unless' => 'Le champ :attribute est interdit sauf si :other figure parmi :values.',
    ...
    */
    ...
    'attributes' => [
        ...
        'social_twitter' => 'lien Twitter',
        'tax_rate' => 'taux de TVA',
        'free_shipping_threshold' => 'seuil de livraison gratuite',
        'international_shipping_fee' => 'frais de livraison internationale',
        'currency' => 'devise',
        'announcement_text' => 'texte d\'annonce',
        'sale_ends_at' => 'fin de la promotion',
        'bank_account_holder' => 'titulaire du compte',
        'bank_name' => 'nom de la banque',
        'bank_iban' => 'IBAN',
        'bank_bic' => 'BIC',
        'notify_new_orders' => 'notification de nouvelles commandes',
